...
public class MnuDuplicateException extends DuplicateDataException {
     ...
     * @param code 오류코드
     */
    public MnuDuplicateException(String code) {
     ...
     * @param cause 원인예외
     */
    public MnuDuplicateException(String code, Throwable cause) {
     ...
     */
    public MnuDuplicateException(String code, Object[] codeMessageArgs) {
     ...
     * @param cause 원인예외
     */
    public MnuDuplicateException(String code, Object[] codeMessageArgs, Throwable cause) {
